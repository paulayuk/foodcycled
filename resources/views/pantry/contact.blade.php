                                ...
                                <div class="row m-0">
                                    <div class="col-lg-8">
                                        <div class="contact-box p-r-40">
                                            ...
                                            <h6 class="subtitle">Got a question? We are always happy to answer!</h6>
                                            <form data-aos="fade-left" data-aos-duration="1200">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <button type="submit" class="btn btn-info-gradiant m-t-20 btn-arrow"><span> SUBMIT <i class="ti-arrow-right"></i></span></button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
